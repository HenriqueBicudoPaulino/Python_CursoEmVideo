#make a program that reads any integer and show it's multiplication table

num = int(input('Type an integer to see it\'s multiplication table: '))
print('---------------')
print('  0 x {} = {}  '.format(num, num * 0))
